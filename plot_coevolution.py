...
OUT = "results/coevolution_1000ep.png"
os.makedirs("results", exist_ok=True)

alice      = pd.read_csv("personality_evolution.csv")
carol      = pd.read_csv("carol_personality_evolution.csv")
alice_reg  = pd.read_csv("cfr_regrets.csv")
carol_reg  = pd.read_csv("carol_cfr_regrets.csv")
adapt      = pd.read_csv("adapted_reciprocity.csv")
